...
import com.example.ScheduleMate.configs.Services.AuthenticationService;
import com.example.ScheduleMate.configs.Services.JwtService;
import com.example.ScheduleMate.dto.LoginResponse;
...
public class AuthenticationController {
    ...
    public ResponseEntity<LoginResponse> authenticate(@RequestBody LoginUserDto loginUserDto) {
        Client authenticatedUser = authenticationService.authenticate(loginUserDto);
